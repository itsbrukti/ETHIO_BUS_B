...
// Get all bookings
$stmt = $pdo->query("
    SELECT b.*, u.name as passenger_name, t.date, t.departure_time, t.price as trip_price
    FROM bookings b
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .status-booked { background: #dbeafe; color: #2563eb; }
    ...
    <div class="admin-container">
        <div class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="manage_bookings.php" class="active"><i class="fas fa-ticket-alt"></i> Bookings</a>
        ...
        <div class="main-content">
            ...
            <div class="table-container">
                <table>
                    <thead>
                        <tr><th>ID</th><th>Passenger</th><th>Date</th><th>Time</th><th>Passengers</th><th>Total Price</th><th>Status</th></tr>
                    </thead>
                    <tbody>
